...
<section class="pull-l-1of12 pull-r-1of12 m-padding">
	...
	<div class="selling-point-grid">
			<div class="service-box" itemscope itemtype="http://schema.org/Service">
				...
				<h4><a itemprop="url" itemprop="name" class="header-link" href="<?php echo site_url().'/search-properties'; ?>">Buy</a></h4>
			...
			<div class="service-box" itemscope itemtype="http://schema.org/Service">
				...
				<h4><a itemprop="url" itemprop="name" class="header-link" href="/#contactUs">Lease</a></h4>
				<p itemprop="description">Check out our listings, or view our specialties.</p>
			</div>
	
			<div class="service-box" itemscope itemtype="http://schema.org/Service">
				<img src="<?php echo get_template_directory_uri(); ?>/library/images/icons/icon-sale.svg" alt="Property for Sale Icon">
				<h4><a itemprop="url" itemprop="name" class="header-link" href="#contactUs">Sell</a></h4>
			...
			<div class="service-box" itemscope itemtype="http://schema.org/Service">
				...
				<h4><a itemprop="url" itemprop="name" class="header-link" href="<?php echo site_url().'/about/team/wernke-team/'; ?>">Invest</a></h4>
			...
			<div class="service-box" itemscope itemtype="http://schema.org/Service">
				...
				<h4><a itemprop="url" itemprop="name" class="header-link" href="tel:317-663-6000">Get Advice</a></h4>
