	...
	<h2 class="header-dark text-center">Everything you need, all in one place.</h2>
		...
		<div class="m-1of2 t-1of3 d-1of3">
			<div class="service-box d-end">
				<img src="<?php echo get_template_directory_uri(); ?>/library/images/icons/icon-sale.svg" alt="Property for Sale Icon">
				<h4><a class="header-link" href="#contactUs">Sell</a></h4>
				<p>Let us help you find the perfect buyer for your property.</p>
				<a class="blue-link" href="/#contactUs">List Your Property</a>
			</div>
		</div>
		...
		<div class="m-1of2 t-1of3 d-1of3">
			<div class="service-box m-end">
				...
				<h4><a class="header-link" href="#contactUs">Invest</a></h4>
				<p>Ranging from student housing to senior living, expand your investment portfolio.</p>
				<a class="blue-link" href="/#contactUs">Browse Investment Properties</a>
			</div>
		</div>
		...
		<div class="m-1of2 t-1of3 d-1of3">
			<div class="service-box">
				...
				<h4><a class="header-link" href="tel:317-663-6000">Get Advice</a></h4>
				<p>Don&#39;t burden yourself! Let an expert help you get you what you need. No strings attached.</p>
				<a class="blue-link" href="tel:317-663-6000" role="telephone">Give us a Call</a>
			</div>
		</div>
		...
		<div class="m-1of2 t-1of3 d-1of3">
			<div class="service-box m-end d-end">
				...
				<h4><a class="header-link" href="<?php echo site_url().'/blog'; ?>">Learn</a></h4>
				<p>What good is knowledge if you don&#39;t share? We compiled a database of info, free for you.</p>
				<a class="blue-link" href="<?php echo site_url().'/blog'; ?>">Read the Blog</a>
			</div>
		</div>
	</div>
</section>