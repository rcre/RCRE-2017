...
function bones_rss_dashboard_widget() {
	if ( function_exists( 'fetch_feed' ) ) {
		...
		$feed = fetch_feed( 'http://feeds.feedburner.com/rcre' );        // specify the source feed
		if (is_wp_error($feed)) {
			$limit = 0;
			$items = 0;
		} else {
...
function bones_custom_admin_footer() {
	_e( '<span id="footer-thankyou">Developed by <a href="https://rcre.com" target="_blank">RESOURCE Commercial Real Estate</a></span>. Built using <a href="http://themble.com/bones" target="_blank">Bones</a>.', 'bonestheme' );
}
